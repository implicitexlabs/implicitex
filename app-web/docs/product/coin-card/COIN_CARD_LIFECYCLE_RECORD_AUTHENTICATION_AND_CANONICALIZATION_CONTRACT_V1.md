...
record contradictions. If `verificationTime` is supplied, it must be an own
enumerable data property; accessors and non-enumerable properties fail closed.
Populated lifecycle registry entries, registry record
